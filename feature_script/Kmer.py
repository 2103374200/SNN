...
def kmer_features(fastas):
    import sequence_read_save
    encodings = Kmer(fastas, 3, "DNA", True, False,)
    sequence_read_save.save_to_csv(encodings,"./features/3_kmer_test.csv")
...
if __name__ == '__main__':
    ...
    fastas = sequence_read_save.read_nucleotide_sequences("../data/testset.txt")
